...
/// @nodoc
abstract class $CancelledOrderStateCopyWith<$Res> {
  factory $CancelledOrderStateCopyWith(
          CancelledOrderState value, $Res Function(CancelledOrderState) then) =
      _$CancelledOrderStateCopyWithImpl<$Res, CancelledOrderState>;
  @useResult
  $Res call(
      {Status status,
      Failure failure,
...
/// @nodoc
class _$CancelledOrderStateCopyWithImpl<$Res, $Val extends CancelledOrderState>
    implements $CancelledOrderStateCopyWith<$Res> {
  _$CancelledOrderStateCopyWithImpl(this._value, this._then);
...
abstract class _CancelledOrderState implements CancelledOrderState {
  const factory _CancelledOrderState(
      {final Status status,
      final Failure failure,
      final GetOrderResponse? orderResponse,
