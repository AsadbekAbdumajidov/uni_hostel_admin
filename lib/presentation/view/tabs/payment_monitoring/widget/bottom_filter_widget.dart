...
class BottomPaymentFilterWidget extends StatelessWidget {
  @override
                          ...
                          return BlocProvider(
                            ...
                            child: BlocBuilder<OnHoverCubit, OnHoverState>(
                              ...
                              return InkWell(
                                ...
                                onTap: () {
                                  bloc.selectDormitory(state.dormitoryList[index]);
                                },
                                child: CheckboxItemRowWidget(
                                  hover: hoverState.hover,
                                  title: state.dormitoryList[index],
                                  value: state.dormitoryIndex == state.dormitoryList[index],
                                ),
