...
class CustomAppBar extends StatelessWidget {
  const CustomAppBar({super.key, this.onchange, this.onCancel,  required this.textEditingController});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            flex: ResponsiveWidget.isTablet(context) ? 0 : ResponsiveWidget.isDesktop(context) ? 4 : 2,
