...
_$MainStatisticsResponseImpl _$$MainStatisticsResponseImplFromJson(
...
Map<String, dynamic> _$$MainStatisticsResponseImplToJson(
        _$MainStatisticsResponseImpl instance) =>
    <String, dynamic>{
      'all': instance.all,
